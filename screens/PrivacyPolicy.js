  ...
  return (
    <SafeAreaView style = {styles.container}>
      ...
      <ScrollView >
        <View>
        <Text>
        <Text style={styles.mainHeader}>MOBILE APP PRIVACY POLICY TEMPLATE </Text>

<Text style={styles.textBody}>We respect the privacy of our users. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our mobile communication application. Please read this Privacy Policy carefully. IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, PLEASE DO NOT ACCESS THE APPLICATION.
...
<Text style={styles.textBody}>We may collect information about you in a variety of ways. The information we may collect via the Application depends on the content and materials you use, and includes:
Personal Data
...
Geo-Location Information : Not applicable for VDLNedcar apps. We may request access or permission to and track location-based information from your mobile device, either continuously or while you are using the Application, to provide location-based services. If you wish to change our access or permissions, you may do so in your device’s settings.
...
Data From Contests, Giveaways, and Surveys : Not applicable for VDLNedcar apps.
Personal and other information you may provide when entering contests or giveaways and/or responding to surveys.
</Text>

<Text style={styles.header}>USE OF YOUR INFORMATION</Text>
Having accurate information about you permits us to provide you with a smooth, efficient, and customized experience. Specifically, we may use information collected about you via the Application to:
<Text style={styles.textBody}>1. Create and manage your account
...
9. Solicit support for the Application.</Text>

<Text style={styles.header}>DISCLOSURE OF YOUR INFORMATION</Text>
<Text style={styles.textBody}>We may share information we have collected about you in certain situations. Your information may be disclosed as follows:
By Law or to Protect Rights
If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation. This includes exchanging information with other entities for fraud protection and credit risk reduction.
Third-Party Service Providers : Not applicable for VDLNedcar apps.
We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.
Marketing Communications : Not applicable for VDLNedcar apps.
...
Third-Party Advertisers : Not applicable for VDLNedcar apps.
...
Affiliates : Not applicable for VDLNedcar apps.
We may share your information with our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include our parent company and any subsidiaries, joint venture partners or other companies that we control or that are under common control with us.
Business Partners : Not applicable for VDLNedcar apps.
We may share your information with our business partners to offer you certain products, services or promotions.
Offer Wall : Not applicable for VDLNedcar apps.
...
Social Media Contacts : Not applicable for VDLNedcar apps.
...
Other Third Parties : Not applicable for VDLNedcar apps.
We may share your information with advertisers and investors for the purpose of conducting general business analysis. We may also share your information with such third parties for marketing purposes, as permitted by law.
Sale or Bankruptcy : Not applicable for VDLNedcar apps.
...
POLICY FOR CHILDREN : Not applicable for VDLNedcar apps.
</Text>
        </Text>
      </View>
    </ScrollView>
